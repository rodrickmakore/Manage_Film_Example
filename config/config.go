...
func initViper() (Constants, error) {
	...
	if os.Getenv("ENVIRONMENT") == "DOCKER" {
		viper.SetConfigName("Manage_Film_Example_docker.config") // Configuration fileName without the .TOML or .YAML extension
	} else {
		viper.SetConfigName("Manage_Film_Example.config") // Configuration fileName without the .TOML or .YAML extension
	}
